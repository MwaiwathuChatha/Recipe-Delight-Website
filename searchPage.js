...
document.addEventListener("DOMContentLoaded", () => {
  const URL = "https://www.themealdb.com/api/json/v1/1/search.php?s=" + searchItemValue;
       ...
       if(data.meals===null)
        {
           ...
           mealTextElement.textContent = "Sorry, the recipe you are looking for was not found.";
